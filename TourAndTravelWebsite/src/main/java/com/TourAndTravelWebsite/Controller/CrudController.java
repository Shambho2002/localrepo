...
public class CrudController {
	...
	public String getRegisterationPage(@RequestParam("name") String name,
										...
										@RequestParam(value = "profilePhotoUrl", required = false) String profilePhotoUrl, // make optional
										Model model) {
		
		if (profilePhotoUrl == null || profilePhotoUrl.isEmpty()) {
	        profilePhotoUrl = "/images/default-avatar.png"; // default photo
	    }
		
		UserRegisteration userregisteration = new UserRegisteration(name,email,password,confirmPassword, profilePhotoUrl);
		userregisteration.setProfilePhotoUrl("/images/default-avatar.png");
